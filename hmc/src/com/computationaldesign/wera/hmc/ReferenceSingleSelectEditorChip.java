...
public class ReferenceSingleSelectEditorChip extends AbstractAttributeEditorChip
{
    private static final String JSP_URI = "/ext/wera/referenceSingleSelectEditorChip.jsp";
	 ...
	 */
	public ReferenceSingleSelectEditorChip(DisplayState displayState, Chip parent, CollectionType type)
	{
...
/*
 * $Log: ReferenceSingleSelectEditorChip.java,v $
