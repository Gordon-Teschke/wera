...
{
    private static final String JSP_URI = "/ext/wera/referenceMultiSelectEditorChip.jsp";
	...
	public void processEvents(Map events)
	{
		if( events.containsKey(PING) && !events.containsKey(SET_VALUE) )
		{
			...
			{
//System.out.println("REferenzMultiSelectEditorChip.processEvents=>"+getCollectionType().newInstance());
		...
		if( events.containsKey(SET_VALUE) )
		{
			...
			{
				// replace old values
//System.out.println("REferenzMultiSelectEditorChip.processEvents=>"+values);
				setValue(values);
			}
...
*/		
	...
	//System.out.println("+++ReferenceMultiSelectEditorChip.isChanged()="+isChanged  );
			return isChanged;
	}
}

/*
 * $Log: ReferenceMultiSelectEditorChip.java,v $
