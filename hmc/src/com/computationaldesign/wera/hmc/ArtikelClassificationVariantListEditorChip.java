...
public class ArtikelClassificationVariantListEditorChip extends GenericReferenceListEditorChip 
{
	private static final String JSP_URI = "/ext/wera/artikelClassificationVariantListEditorChip.jsp";
	...
	public void setValue(Object arg0) {
		...
		//System.out.println("*****************setValue (v)="+arg0);
		...
		//System.out.println("*****************setValue (N)="+colList);
	...
	public ArtikelClassificationVariantListEditorChip(DisplayState displayState, Chip parent)
	{
...
*/			
	...
	{
		return new ArtikelClassificationVariantListChip(getDisplayState(), this, elementType);
	}	
