...
%>
<table class="mediaFileUploadEditorChip" id="gt">
<%
	if( showPreview )
	{
%>
				...
				<tr>
					<td>
						<div class="xp-button<%= isUploadEnabled ? " chip-event" : "-disabled" %>">
							<a style="width:100px;" href="#" title="<%= localized("upload") %>" 
					...
					<td>
						<div class="xp-button<%= isPreviewEnabled ? " open-url" : "-disabled" %>">
							<a style="width:100px;" href="#" title="<%= localized("preview") %>" 
					...
					<td>
						<div class="xp-button<%= isDownloadEnabled ? " open-url" : "-disabled" %>">
							<a style="width:100px;" href="#" title="<%= localized("download") %>" 
