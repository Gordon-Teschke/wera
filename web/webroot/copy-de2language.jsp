...
<html>
<head>
	<title>Wera hybris data migrator</title>
...
<%
	...
	colLanguages.add(sLanguage);
	
	DataCorrector dc = new DataCorrector();
	dc.corrData_copyVariantActivationFromDEtoLanguage(sLanguage);
	dc.corrDataAktiv(sLanguage);
	//dc.copyOutputcontrolUnits( colLanguages );
